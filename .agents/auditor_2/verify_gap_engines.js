...
const filePath = path.join(__dirname, '../../src/js/components/gap-solutions-engine.js');
const rawCode = fs.readFileSync(filePath, 'utf-8');
const wrappedCode = rawCode.replace('export class GapSolutionsEngine', 'class GapSolutionsEngine') + '\nmodule.exports = { GapSolutionsEngine };';

const m = new module.constructor();
m.paths = module.paths;
m._compile(wrappedCode, filePath);
const { GapSolutionsEngine } = m.exports;
